...
public class ExempleSchemaTab {
	...
	public static void main(String[] args) {
		...
		// Définir le schéma en utilisant une liste
		List<FormeGeometrique> schema = new ArrayList<>();
		schema.add(s12);
		schema.add(s23);
		schema.add(s31);
		...
		for (FormeGeometrique element : schema) {
			element.afficher();
			System.out.println();
		}
